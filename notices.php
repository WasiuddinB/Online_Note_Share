...
<span class="head" style="float: left; color: black;">Online Notice Control</span><br />
...
<tr>
  <td class="labels">Access Type</td>
  <td>
...
<tr>
  ...
  <td>
    <input name="title" type="text" class="fields" id="title" placeholder="Enter Title" size="45" />
  </td>
</tr>


<tr>
  <td class="labels">Notice</td>
  <td>
    <textarea name="notice" cols="35" class="fields" id="notice" style="height:70px;font-family:'trebuchet MS';" placeholder="Enter Notice"></textarea>
  </td>
</tr>
...
<tr>
  <td colspan="2" align="center">
    <input type="submit" value="Submit" class="button" onclick="return confirm('Are You Sure...?');"/>
  </td>
</tr>
