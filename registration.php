...
<body style="background-image: url('../images/backtree.jpg');">
<div align="center">
<span class="head" style="float:left; color:black;">Student Registration Panel</span> <br /><br /><br />
...
<tr><td class="labels">Student ID : </td><td><input name="roll" type="text" class="fields" id="roll" placeholder="Enter Roll No." size="15"/></td></tr>
...
<tr><td class="labels">Department : </td><td>
<select name="branch" class="fields">
	   <option value="NA" selected="selected" disabled="disabled">- - Select Department - - </option>
       <option value="Civil Engineering">Civil Engineering</option>
       <option value="Computer Science and Engineering">Computer Science and Engineering</option>
       <option value="Electrical Engineering">Electrical and Electronics Engineering</option>
       <option value="Basic Sciences">Bachelor of Business Administration</option>
       </select>
</td></tr>
...
<tr><td align="center" colspan="2"><input type="submit" value="Register" class="button" style="width: 40%; height: 50px;" onclick="return confirm('Please Confirm All Fields Before Submitting');" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="Clear"  class="button" style="width: 40%; height: 50px;" onclick="return confirm('Are You Sure...?');"/></td></tr>
</table>
</form><br />
