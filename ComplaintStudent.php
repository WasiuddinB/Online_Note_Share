...
else
{
	...
	mysqli_query($techVegan,"INSERT INTO complaints(complaint,byy,date,access,file) VALUES('$comp','$by','$date','0','$filename')");
	$info="Successfully Submitted Your Note ";
}
?>
...
<span class="head" style="float:left; color: black;">Welcome To Notes Box</span><br />
...
<span class="Subhead">Upload Your Notes</span><br />
<form method="post" action="">
<table cellpadding="3" cellspacing="3" class="formTable">
<tr><td colspan="2" align="center" class="info"><?php echo $info;?></td></tr>
<tr><td class="labels">Note Description : </td><td><textarea name="comp" rows="5" cols="30" class="fields" style="height:70px;"></textarea></td></tr>

<tr>
  <td class="labels">Note File: </td>
  <td>
...
<tr><td align="center" colspan="2"><input type="submit" value="UPLOAD" class="button" onclick="return confirm('After Submitting Your note, You will not be able To Delete or Modify it.');" /></td></tr>
</table>
</form>
